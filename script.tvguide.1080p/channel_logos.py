...
if __name__ == '__main__':
    ...
    def onInitialized(success):
        if success:
            ...
            xbmcvfs.mkdirs("special://profile/addon_data/script.tvguide.1080p/channel_logos/")
            for channel in channelList:
                from_file = channel.logo
                regex = '[%s]' % re.escape('[]/\:')
                xbmc.log(regex)
                to_file = "special://profile/addon_data/script.tvguide.1080p/channel_logos/%s.png" % re.sub(regex,' ',channel.title)
